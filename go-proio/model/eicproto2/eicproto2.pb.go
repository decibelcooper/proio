...
// source: proio/model/eicproto2.proto

/*
	Package eicproto2 is a generated protocol buffer package.

	It is generated from these files:
		proio/model/eicproto2.proto
...
func (RandVar_Distribution) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorEicproto2, []int{6, 0}
}
...
func (*Particle) Descriptor() ([]byte, []int) { return fileDescriptorEicproto2, []int{0} }
...
func (*SimHit) Descriptor() ([]byte, []int) { return fileDescriptorEicproto2, []int{1} }
...
func (*EnergyDep) Descriptor() ([]byte, []int) { return fileDescriptorEicproto2, []int{2} }
...
func (*Track) Descriptor() ([]byte, []int) { return fileDescriptorEicproto2, []int{3} }
...
func (*TrackSegment) Descriptor() ([]byte, []int) { return fileDescriptorEicproto2, []int{4} }
...
func (*ObservedPos) Descriptor() ([]byte, []int) { return fileDescriptorEicproto2, []int{5} }
...
type RandVar struct {
	Dist *RandVar_Distribution `protobuf:"varint,2,opt,name=dist,enum=proio.model.eicproto2.RandVar_Distribution" json:"dist,omitempty"`
	// spatial in mm and time in ns
...
func (*RandVar) Descriptor() ([]byte, []int) { return fileDescriptorEicproto2, []int{6} }
...
func (*XYZTD) Descriptor() ([]byte, []int) { return fileDescriptorEicproto2, []int{7} }
...
func (*XYZTF) Descriptor() ([]byte, []int) { return fileDescriptorEicproto2, []int{8} }
...
func (*XYZD) Descriptor() ([]byte, []int) { return fileDescriptorEicproto2, []int{9} }
...
func (*XYZF) Descriptor() ([]byte, []int) { return fileDescriptorEicproto2, []int{10} }
...
func init() {
	proto.RegisterType((*Particle)(nil), "proio.model.eicproto2.Particle")
	proto.RegisterType((*SimHit)(nil), "proio.model.eicproto2.SimHit")
	proto.RegisterType((*EnergyDep)(nil), "proio.model.eicproto2.EnergyDep")
	proto.RegisterType((*Track)(nil), "proio.model.eicproto2.Track")
	proto.RegisterType((*TrackSegment)(nil), "proio.model.eicproto2.TrackSegment")
	proto.RegisterType((*ObservedPos)(nil), "proio.model.eicproto2.ObservedPos")
	proto.RegisterType((*RandVar)(nil), "proio.model.eicproto2.RandVar")
	proto.RegisterType((*XYZTD)(nil), "proio.model.eicproto2.XYZTD")
	proto.RegisterType((*XYZTF)(nil), "proio.model.eicproto2.XYZTF")
	proto.RegisterType((*XYZD)(nil), "proio.model.eicproto2.XYZD")
	proto.RegisterType((*XYZF)(nil), "proio.model.eicproto2.XYZF")
	proto.RegisterEnum("proio.model.eicproto2.RandVar_Distribution", RandVar_Distribution_name, RandVar_Distribution_value)
}
...
func (m *Particle) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Parent) > 0 {
		for _, num := range m.Parent {
			dAtA[i] = 0x8
			i++
			i = encodeVarintEicproto2(dAtA, i, uint64(num))
		}
	}
	if len(m.Child) > 0 {
	...
	if m.Pdg != nil {
		dAtA[i] = 0x18
		i++
		i = encodeVarintEicproto2(dAtA, i, uint64((uint32(*m.Pdg)<<1)^uint32((*m.Pdg>>31))))
	}
	if m.Vertex != nil {
		dAtA[i] = 0x22
		i++
		i = encodeVarintEicproto2(dAtA, i, uint64(m.Vertex.Size()))
	...
	if m.P != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintEicproto2(dAtA, i, uint64(m.P.Size()))
	...
	if m.Spin != nil {
		dAtA[i] = 0x42
		i++
		i = encodeVarintEicproto2(dAtA, i, uint64(m.Spin.Size()))
...
func (m *SimHit) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Volumeid != nil {
		dAtA[i] = 0x8
		i++
		i = encodeVarintEicproto2(dAtA, i, uint64(*m.Volumeid))
	}
	if m.Globalprepos != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintEicproto2(dAtA, i, uint64(m.Globalprepos.Size()))
	...
	if m.Globalpostpos != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintEicproto2(dAtA, i, uint64(m.Globalpostpos.Size()))
	...
	if m.Particle != nil {
		dAtA[i] = 0x28
		i++
		i = encodeVarintEicproto2(dAtA, i, uint64(*m.Particle))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *EnergyDep) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Pos) > 0 {
		for _, msg := range m.Pos {
			dAtA[i] = 0x1a
			i++
			i = encodeVarintEicproto2(dAtA, i, uint64(msg.Size()))
...
func (m *TrackSegment) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Poq != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintEicproto2(dAtA, i, uint64(m.Poq.Size()))
	...
	if m.Curvature != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintEicproto2(dAtA, i, uint64(m.Curvature.Size()))
...
func (m *ObservedPos) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Mean != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintEicproto2(dAtA, i, uint64(m.Mean.Size()))
...
func (m *RandVar) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Dist != nil {
		dAtA[i] = 0x10
		i++
		i = encodeVarintEicproto2(dAtA, i, uint64(*m.Dist))
	}
	if m.Sigma != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintEicproto2(dAtA, i, uint64(m.Sigma.Size()))
...
func encodeVarintEicproto2(dAtA []byte, offset int, v uint64) int {
	for v >= 1<<7 {
...
func (m *Particle) Size() (n int) {
	...
	if m.Pdg != nil {
		n += 1 + sozEicproto2(uint64(*m.Pdg))
	}
	if m.Vertex != nil {
		l = m.Vertex.Size()
		n += 1 + l + sovEicproto2(uint64(l))
	}
	if m.P != nil {
		l = m.P.Size()
		n += 1 + l + sovEicproto2(uint64(l))
...
func (m *SimHit) Size() (n int) {
	...
	_ = l
	if m.Volumeid != nil {
		n += 1 + sovEicproto2(uint64(*m.Volumeid))
	}
	if m.Globalprepos != nil {
	...
	if m.Particle != nil {
		n += 1 + sovEicproto2(uint64(*m.Particle))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *RandVar) Size() (n int) {
	...
	_ = l
	if m.Dist != nil {
		n += 1 + sovEicproto2(uint64(*m.Dist))
	}
	if m.Sigma != nil {
		l = m.Sigma.Size()
		n += 1 + l + sovEicproto2(uint64(l))
...
func sovEicproto2(x uint64) (n int) {
	for {
		n++
		x >>= 7
		if x == 0 {
...
func sozEicproto2(x uint64) (n int) {
	return sovEicproto2(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *Particle) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowEicproto2
			}
			if iNdEx >= l {
		...
		case 1:
			if wireType == 0 {
				...
				if packedLen < 0 {
					return ErrInvalidLengthEicproto2
				}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipEicproto2(dAtA[iNdEx:])
			if err != nil {
				return err
			}
			if skippy < 0 {
...
func skipEicproto2(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		var wire uint64
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowEicproto2
			}
			if iNdEx >= l {
		...
		case 2:
			...
			iNdEx += length
			if length < 0 {
				return 0, ErrInvalidLengthEicproto2
			}
			return iNdEx, nil
		case 3:
			for {
				...
				next, err := skipEicproto2(dAtA[start:])
				if err != nil {
					return 0, err
				}
				iNdEx = start + next
...
var (
	ErrInvalidLengthEicproto2 = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowEicproto2   = fmt.Errorf("proto: integer overflow")
)

func init() { proto.RegisterFile("proio/model/eicproto2.proto", fileDescriptorEicproto2) }

var fileDescriptorEicproto2 = []byte{
	// 761 bytes of a gzipped FileDescriptorProto
	,
}
